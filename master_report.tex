...
The Ising model is broadly used in statistical physics to study phase transitions. The model describes a set of lattice sites with discrete variables that represent the atomic spins while in either up ($\ket{\uparrow}$) or down ($\ket{\downarrow}$). The three components of the operators when applying to the Hilbert space spanned by $\ket{\uparrow}$ and $\ket{\downarrow}$ are defined as \\
...
The quantum annealing process can be described by the time-dependent Schrödinger equation, and thus the final state of the system can be determined by solving the time-dependent Schrödinger equation. The solution of the time-dependent Schrödinger equation provided in Eq. (\ref{tdse}) is \\
...
%		\includegraphics[width=\linewidth]{Coherent.png}	
		\includegraphics[width=\linewidth]{Figure_redraw_thermal.eps}
		\caption{}
		%		\label{fig:energy_spectrum_close}
	\end{subfigure}

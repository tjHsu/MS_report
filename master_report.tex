...
\subsection{the evolution of the spin, energy, and success probability during the annealing}
	\begin{itemize}
		\item Figure here: The system energy vs. lambda
		\item Figure here: The spin x vs. lambda
		\item Figure here: The spin z vs. lambda
		\item Figure here: The success probability vs. lambda
	\end{itemize}
\subsubsection{The Effect of step size tau}
	\begin{itemize}
		\item Figure here: compare the result of product formula with the result of full diagonalization: success probability vs. annealing Time with different tau
	\end{itemize}
...
\subsubsection{The Effect of Minimum Gap}
	\begin{itemize}
		\item Figure here: energy spectrum: the energy for all states vs. lambda
		\item Figure here: a close view of the result above: the energy for lowest 20~30 states vs. lambda
		\item Figure here: compare: the success probability under the annealing time that maximise the minimum gap difference vs. minimum gap value 
	\end{itemize}
...
\subsubsection{The Process toward Quasi-static}
	\begin{itemize}
		\item Figure here: display plots with different temperature: success probability with different coupling factor vs. annealing time
		
		\item Figure here: repeat above plots with Random wave function
	\end{itemize}

...
\section{Applicatoin on Machine Learning / Simulation}
	...
	,where n is the dimension of the data, m is the number of the data, k is the number of the feature extracted and $k < n$. The matrix elements of $W$ must be nonnegative and the matrix elements of $H$ must be binary. \\

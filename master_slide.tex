...
\begin{frame}
	...
	For example, a 2-SAT problem can be written as 
	\begin{equation*}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[height=150pt]{result_picture/probability_spin_system/Figure_Annealing_spin.png}
		\caption{An result with total annealing time = 1000}
		% \caption{Insert Caption here}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}
		...
		\includegraphics[height=150pt]{result_picture/gap_result_environment/Figure_PvsGap_no_coupling_Temp1.eps}
		 ...
		 \caption{A plot with 100 Hamiltonian sets.}
	\end{figure}
\end{frame}
%------------------------------------------------------------------------------------------
